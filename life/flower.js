...
function Flower(config, canvasController){
    ...
    // All mode: draw every petal each frame
    ...
    function renderAll(petals){
        // clear
        // canvasController.drawSquare(0,0,config.canvasWidth + config.canvasHeight, "rgb(255,255,255)")
        canvasController.clear()
        // fast render all
        const xyPxs = petals.map(p => [p.array[0].array[0], p.array[1].array[0]])
        canvasController.drawCircles(xyPxs, 5, "rgb(180,30,60)")
    }
}